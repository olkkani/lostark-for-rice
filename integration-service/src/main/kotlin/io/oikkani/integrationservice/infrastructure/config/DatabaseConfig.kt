...
class RedisConfiguration(
    @param:Value("\${redis.host:localhost}") private val host: String,
    @param:Value("\${redis.port:6379}") private val redisPort: Int,
    @param:Value("\${redis.password:}") private val redisPassword: String,
) {
    @Bean
